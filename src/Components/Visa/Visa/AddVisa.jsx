  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 p-6 bg-white dark:bg-gray-800 shadow-md rounded-lg">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Additional Fields */}
        {/* Repeat similar changes for other input fields like description, requiredDocuments, etc. */}

        {/* Submit Button */}
        <button
          type="submit"
          className="btn btn-primary w-full mt-4 dark:bg-blue-600 dark:hover:bg-blue-500"
        >
          Add Visa
        </button>
      </form>
